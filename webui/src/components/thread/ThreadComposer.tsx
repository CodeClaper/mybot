          ...
          <Button
            ...
            className={cn(
              ...
              showStopButton
                ...
                : isHero
                  ? "border border-primary bg-primary text-primary-foreground shadow-[0_4px_12px_rgba(57,100,254,0.35)] hover:bg-primary/90 disabled:border-primary/35 disabled:bg-primary/35 disabled:text-primary-foreground/80"
                  : "border border-primary bg-primary text-primary-foreground shadow-[0_3px_10px_rgba(57,100,254,0.30)] hover:bg-primary/90 disabled:border-primary/35 disabled:bg-primary/35 disabled:text-primary-foreground/80",
              isHero ? "" : "h-7.5 w-7.5",
