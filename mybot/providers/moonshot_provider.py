...
class MoonshotProvider(BaseProvider):
    def __init__(
        ...
        self._client = AsyncOpenAI(
            api_key=api_key or "",
            base_url=api_base or _MOONSHOT_BASE_URL,
        )
        logger.debug("Using moonshot provider")
    ...
    async def chat(
        ...
        try:
            ...
            return LLMResponse(content=f"Error calling Moonshot: {str(e)}", finish_reason="error")
